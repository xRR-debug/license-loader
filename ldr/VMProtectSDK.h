...
#ifdef ENABLE_VMP
#define VMP(string) VMProtectBegin(string)
#define VMP_ULT(string) VMProtectBeginUltra(string)
#define VMP_VIR(string) VMProtectBeginVirtualization(string)
#define VMP_MUT(string) VMProtectBeginMutation(string)
#define VMP_END VMProtectEnd()
#else
#define VMP(string)
#define VMP_ULT(string) 
#define VMP_VIR(string)
#define VMP_MUT(string) 
#define VMP_END
#endif
