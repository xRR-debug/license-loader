...
using oNtWriteVirtualMemory = LONG(NTAPI*)(HANDLE ProcessHandle, PVOID BaseAddress, PVOID Buffer, ULONG NumberOfBytesToWrite, SIZE_T* NumberOfBytesWritten);
...
}; inline std::shared_ptr<NtFunctions> nt;
